...
from openprocurement.auctions.sspinsider.models import DGFInsider, IInsiderAuction
from openprocurement.auctions.sspinsider.adapters import (
    AuctionInsiderConfigurator,
    AuctionInsiderManagerAdapter
)
from openprocurement.auctions.sspinsider.constants import (
...
def includeme(config, plugin_config=None):
    ...
    LOGGER.info("Included openprocurement.auctions.sspinsider plugin", extra={'MESSAGE_ID': 'included_plugin'})
