...
from openprocurement.auctions.sspinsider.utils import invalidate_empty_bids, merge_auction_results
from openprocurement.auctions.sspinsider.validation import (
...
@opresource(name='dgfInsider:Auction Auction',
            ...
            description="SSPInsider auction auction data")
